...
# vision model: ~6x cheaper than gemini-2.5-pro while still handling both
# images and videos (only Google Gemini models can caption videos on
# OpenRouter). Override with --model — e.g. 'google/gemini-3-flash-preview'
# (higher quality) or 'google/gemini-2.5-pro' (highest quality). Model ids
# must be the full 'provider/slug' form (a bare slug yields "Unknown model").
