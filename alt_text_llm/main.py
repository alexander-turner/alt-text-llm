...
# video-capable vision model: ~5x cheaper than gemini-2.5-pro while still
# handling both images and videos (only Google Gemini models can caption
# videos on OpenRouter). Override with --model — e.g.
# 'google/gemini-2.5-flash-lite' (cheapest) or 'google/gemini-2.5-pro'
# (highest quality). Model ids must be the full 'provider/slug' form.
